...
|---------------------------------------|-----------------------------------------------------------------|
|              **Symbol**               |                           **Meaning**                           |
|[`*`](https://www.mankier.com/1/tmux#*)|                   Denotes the current window.                   |
|                  `-`                  |          Marks the last window (previously selected).           |
|                  `#`                  |  Window activity is monitored and activity has been detected.   |
|[`!`](https://www.mankier.com/1/tmux#!)|Window bells are monitored and a bell has occurred in the window.|
|[`~`](https://www.mankier.com/1/tmux#~)|  The window has been silent for the monitor-silence interval.   |
...
[\-T](https://www.mankier.com/1/tmux#-T) tells **tmux** the prompt type. This affects what completions are offered when *Tab* is pressed. Available types are: ‘`command`’, ‘`search`’, ‘`target`’ and ‘`window-target`’.
...
display-menu [-O] [[-c](https://www.mankier.com/1/tmux#-c)target-client] [-t target-pane] [[-T](https://www.mankier.com/1/tmux#-T)title] [-x position] [-y position] namekeycommand...
>
>
> (alias: `menu`)
>
...
|[`R`](https://www.mankier.com/1/tmux#R)|  `-x`  |    The right side of the terminal     |
|[`P`](https://www.mankier.com/1/tmux#P)|  Both  |      The bottom left of the pane      |
|                  `M`                  |  Both  |          The mouse position           |
|[`W`](https://www.mankier.com/1/tmux#W)|  Both  |The window position on the status line |
...
|                  `T`                  |        Tag no buffers        |
|                 `C-t`                 |       Tag all buffers        |
|[`p`](https://www.mankier.com/1/tmux#p)|    Paste selected buffer     |
|                  `P`                  |     Paste tagged buffers     |
|                  `d`                  |    Delete selected buffer    |
|                  `D`                  |    Delete tagged buffers     |
|[`e`](https://www.mankier.com/1/tmux#e)| Open the buffer in an editor |
|                  `f`                  |Enter a format to filter items|
|                  `O`                  |      Change sort field       |
|                  `r`                  |      Reverse sort order      |
|                  `v`                  |        Toggle preview        |
...
This is equivalent to the *RGB*[terminfo(5)](https://www.mankier.com/5/terminfo) capability.

*Ms*

Store the current buffer in the host terminal's selection (clipboard). See the *set-clipboard* option above and the [xterm(1)](https://www.mankier.com/1/xterm) man page.
...
%extended-output pane-idage... : value
...
%layout-change window-idwindow-layoutwindow-visible-layoutwindow-flags
...
%session-changed session-idname
...
%session-window-changed session-idwindow-id
...
%subscription-changed namesession-idwindow-idwindow-indexpane-id ... : value
...
](https://www.mankier.com/1/tmux#Files)\~/.tmux.conf$XDG\_CONFIG\_HOME/tmux/tmux.conf\~/.config/tmux/tmux.conf
...
](https://www.mankier.com/1/tmux#Authors)
